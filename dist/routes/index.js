...
router.post('/bookings', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.get('/bookings/:email', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/classes', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, classController_1.createClass)(req, res);
    }
    catch (err) {
        next(err);
    }
